class CategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @category.save
        format.html { redirect_to categories_path, success: 'Category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @category.update(category_params)
        format.html { redirect_to categories_path, info: 'Category was successfully updated.' }
  ...
  private
    ...
    def category_params
      params.require(:category).permit(:tag, :project_id)
    end
end
